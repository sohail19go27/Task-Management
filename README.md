...
Handles different Tasks Assigned to it and working on it.It has a number of tasks list to be done by it to solve it. It handles Tasks Efficiently. Its performs better.
